...
public class Parser/*@bgen(jjtree)*/implements ParserTreeConstants, ParserConstants {/*@bgen(jjtree)*/
 ...
 /*@bgen(jjtree) Program */
  ...
  static final public ASTEnd End(String programName) throws ParseException {
 /*@bgen(jjtree) End */
...
//________________STATEMENTs___________
 ...
 jjtree.openNodeScope(jjtn000);Token t;
  ...
  static final public Token ProcedureCall() throws ParseException {
 ...
 jjtree.openNodeScope(jjtn000);Token t;
    try {
      t = jj_consume_token(ident);
                jjtn000.setIdent(t.image); jjtn000.setToken(t); jjtn000.setKind(Symbol.Procedure);
      jj_consume_token(23);
      if (jj_2_29(2)) {
        ArgumentList();
      } else {
