/* Generated By:JavaCC: Do not edit this line. Symbolchecker.java */
package yapl.compiler;
import yapl.interfaces.CompilerError;
import yapl.lib.CompilerMessage;
import yapl.symbol.Symboltable;
import java.io.FileInputStream;
import java.io.FileNotFoundException;

/** CA2.3 */
public class Symbolchecker implements SymbolcheckerConstants {
  ...
  public static void main(String args[]) {
        ...
        try{
            Symbolchecker symbolchecker = new Symbolchecker(new FileInputStream(args[0]));
            symbolchecker.Program();
  ...
  static final public void Program() throws ParseException {
    ...
    endIdent = jj_consume_token(ident);
        if(!programName.equals(endIdent)) {if (true) throw new YAPLException("", CompilerError.EndIdentMismatch, t.beginLine, t.beginColumn);}
...
//__________________OPs_______________
  ...
  static public SymbolcheckerTokenManager token_source;
  ...
  public Symbolchecker(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Symbolchecker(java.io.InputStream stream, String encoding) {
    ...
    token_source = new SymbolcheckerTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Symbolchecker(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public Symbolchecker(SymbolcheckerTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(SymbolcheckerTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
